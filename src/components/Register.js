                ...
                <div className="grid">
                    ...
                    <form className="login form">
                        ...
                        <div className="form__field">
                            ...
                            <input id="login__username" type="email" name="username" className="form__input" placeholder="Fullname" required />
                        </div>

                        <div className="form__field">
                            <label htmlFor="login__username"><span>Email</span></label>
                            <input id="login__username" type="email" name="username" className="form__input" placeholder="Username" required />
                        </div>
                        ...
                        <div className="form__field">
                            <label htmlFor="login__password"><span>Confirm Password</span></label>
                            <input id="login__password" type="password" name="password" className="form__input" placeholder="Re-Enter" required />
                        </div>

                        <div className="form__field">
                            <label htmlFor="login__password"><span>Age</span></label>
                            <input id="login__password" type="number"  name="age" className="form__input" placeholder="Age" />
                        </div>
